...
interface INodeManager {
    function createValidator(address consensusAddress, address signerAddress, address proposalAddress, int commission, string calldata desc) external returns(bool success);
