module github.com/polynetwork/zion-example
...
replace (
	github.com/ethereum/go-ethereum v1.11.5 => /Users/zhangmenghang/Documents/gopath/src/github.com/polynetwork/Zion
